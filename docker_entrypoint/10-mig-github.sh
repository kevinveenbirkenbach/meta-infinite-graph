...
${ALERT_LOCATIONS}
  ...
  location ~ "^/gh/((repos/[A-Za-z0-9_.-]+/[A-Za-z0-9_.-]+|repositories/[0-9]+)(/(forks|branches|tags|commits|pulls)(/[0-9a-fA-F]{7,40})?|/actions/runs(/[0-9]+/(artifacts|jobs))?|/check-runs/[0-9]+/annotations)?)\$" {
    resolver 127.0.0.11 1.1.1.1 valid=300s ipv6=off;
